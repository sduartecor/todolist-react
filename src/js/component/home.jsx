...
const Home = () => {
  ...
  {lista.map((tarea, id) =>  <li  className="list-group-item fs-5 px-5" key={id}>{tarea} <button type="button" className="btn-close border-0 float-end"  onClick={() => removeTarea(id)}></button> </li>  )}
